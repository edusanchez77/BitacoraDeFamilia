...
class AddInfoViewModel: ViewModel() {
    ...
    val title = R.string.add_info_title
    val save = R.string.add_button_save
    val cancel = R.string.add_button_cancel
    val back = R.string.add_button_back
    val editTextWhen = R.string.add_info_edittext_when
    val editTextHow = R.string.add_info_edittext_how
    val editTextReactions = R.string.add_info_edittext_reactions
    ...
    fun save(info: PregnantInfo){
        FirebaseDBService.save(info)
    }
