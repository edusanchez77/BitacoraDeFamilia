/**
 *  Created by CbaElectronics by Eduardo Sanchez on 3/1/23, 10:29 AM.
...
class ShareRouter: BaseActivityRouter {

    override fun intent(activity: Context): Intent = Intent(activity, ShareActivity::class.java)
